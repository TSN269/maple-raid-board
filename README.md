...
```text
supabase/ui-7-7-artale-merge-legacy-keys.sql
```
...
2. 開啟 Artale 物價查詢
3. 按「重新讀取報價」
4. 到 Supabase SQL Editor 執行 supabase/ui-7-7-artale-merge-legacy-keys.sql
5. 再按一次「重新讀取報價」
```
...
新增 supabase/ui-7-7-artale-merge-legacy-keys.sql
